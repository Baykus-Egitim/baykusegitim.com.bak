...
Mobile devices: Navigate to WhatsApp App.

Desktop (non-mobile devices): WhatsApp Webpage will open in a new tab (web.whatsapp.com). user can chat directly from the browser.

[Documentation, Demo, Examples](https://www.holithemes.com/whatsapp-chat/)

Thanks to everyone for making this WhatsApp plugin as Highest activated plugin.
...
And there are lot more features, we can change the display style to any predefined style or can add any image/ GIF. And can place at any position of the screen.
...
* Working Hours - Hide Styles on Selected Time Range in a Day
...
https://www.holithemes.com/whatsapp-chat/find-whatsapp-group-id/
...
https://wordpress.org/support/plugin/click-to-chat-for-whatsapp/

* Give support
If you like the plugin support the developers by giving 5 star rating
https://wordpress.org/support/plugin/click-to-chat-for-whatsapp/reviews/#new-post
